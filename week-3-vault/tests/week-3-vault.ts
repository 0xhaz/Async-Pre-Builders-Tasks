...
import { Week3Vault } from "../target/types/week_3_vault";
...
describe("anchor_vault", () => {
  ...
  const program = anchor.workspace.Week3Vault as Program<Week3Vault>;
  const user = provider.wallet.publicKey;

  // Derive the PDA for the vault state account
